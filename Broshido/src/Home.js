    ...
    <div className="backgroundImage">
      <div className="page_container">
        ...
        <div className="hook_information">
          <p>
            Here at Broshido we are determined to fulfill your needs. Samurai
            are not a thing of the past. We have the best samurai who will help
            you out in our modern world. Do you feel you have a yokai haunting
            you? Or you need a body guard to protect you? We have just the
            samurai for you. Our samurai can even entertain at parties or play
            pranks on your friends! Let our samurai help you today!
          </p>
        </div>
        ...
        <div className="typesOfSamurai_wrapper">
          <div className="type">
            ...
            <p>
              Yokai can be so annoying and even more annoying to get rid of.
              These Samurai can help!
            </p>
          </div>
          <div className="type">
            <h1>BODY GAURD</h1>
